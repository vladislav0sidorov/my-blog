...
describe('loginSlice.test', () => {
  ...
  test('test set cancel edit', () => {
    ...
    expect(profileReducer(state as ProfileSchema, profileActions.cancelEditProfile())).toEqual({
      readonly: true,
  ...
  test('test set update profile', () => {
    ...
    expect(profileReducer(state as ProfileSchema, profileActions.updateProfile({ username: 'new-username' }))).toEqual({
      form: {
        username: 'new-username',
      },
    })
